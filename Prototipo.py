...
##########      FASE FINAL      ############
    ...
    for endpoint_type_PK in data['types']:
        ...
        #Aqui pode ter ficado meio confuso, mas como os dados de dano estavam dentro de listas e eu não consegui converter
        # para dicionários, fiz um loop e defini a variável name equivalente ao nome do tipo de pokemon que está dentro de cada
        # damage_relations, na damage relation que equivale a double_damage_from, vou pegar os nomes dos tipos e adicionar a uma lista
        # aqui descobri que a relação de dano no caso (double damage from) é uma string
...
"""
__ antes de uma variável a transforma em privada (dois underlines)
"""